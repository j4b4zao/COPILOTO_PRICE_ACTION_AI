"""Gravação explícita e atômica do dashboard psicológico (RC26)."""
...
class TraderPsychologyDashboardFileExportResult:
    status: str
    destination: str
    bytes_written: int
    sha256: str
...
class TraderPsychologyDashboardFileExporter:
    """Persiste somente quando chamado com destino absoluto."""

    NAME = "TraderPsychologyDashboardFileExporter"
    VERSION = "RC26"
    ...
    def write(
        ...
        *,
        ...
        content = (
            dashboard_export.to_json(indent=2) + "\n"
        ).encode("utf-8")
        ...
        return TraderPsychologyDashboardFileExportResult(
            status="WRITTEN",
