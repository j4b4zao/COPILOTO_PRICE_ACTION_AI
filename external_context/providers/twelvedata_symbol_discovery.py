...
class TwelveDataSymbolDiscovery(SymbolDiscovery):
    ...
    def classify_provider_error(
        ...
        UNAVAILABLE:
            instrumento/recurso existe, mas requer
            plano ou permissão superior.

        PROVIDER_ERROR:
            autenticação, rate limit, conexão ou
