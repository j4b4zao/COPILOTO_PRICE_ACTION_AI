...
def warm_history(symbol, *, interval=0.25, max_warmup_cycles=4800, sleeper=time.sleep, collector=None, pipeline=None):
        ...
        try:
            ...
            if context is None:
                ...
                print(
                    ...
                    f'structure={structure_trend} pa_bias={pa_bias} ready={ready}'
                )
                if ready:
                    return {
