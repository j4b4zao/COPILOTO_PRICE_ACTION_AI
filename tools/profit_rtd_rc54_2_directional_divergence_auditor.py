...
def main(argv=None):
    ...
    for key in ('price_action_market_structure_integration','observational_only','predictive_claim_allowed','score_influence_allowed','decision_influence_allowed','order_execution_allowed'):
        print(f'{key}={r[key]}')
    return 0
