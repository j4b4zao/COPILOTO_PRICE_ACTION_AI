...
def _load_session(path, *, require_data_ready=True):
    ...
    if require_data_ready and payload.get('data_ready') is not True:
        raise ValueError(f'RC54_5_REQUIRES_DATA_READY_SESSION:{path}')
